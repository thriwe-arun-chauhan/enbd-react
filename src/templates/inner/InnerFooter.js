                            ...
                            <div className="col-lg-3 col-md-6 col-12">
                                <div className="single-widget footer-about widget">
                                    ...
                                    <div className="footer-widget-about-description">
                                        <p>Exclusive benefits program for EmiratesNBD eligible card holders.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-3 col-md-6 col-12">
                                <div className="single-widget f-link widget">
                                    ...
                                    <ul>
                                        ...
                                        // href="javascript:void(0);" 
                                        link="https://emiratesnbdbenefits.thriwe.com/faqs">FAQ'S</a></li>
                                        <li><a className="leave_site" 
                                        // href="javascript:void(0);" 
                                        link="https://emiratesnbdbenefits.thriwe.com/terms-and-conditions">Terms &amp; Conditions</a></li>
                                        <li><a className="leave_site" 
                                        // href="javascript:void(0);" 
                                        link="https://emiratesnbdbenefits.thriwe.com/privacy-policy">Privacy Policy</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div className="col-lg-6 col-md-6 col-12">
                                <div className="single-widget footer_contact widget">
                                    ...
                                    <ul className="address-widget-list">
                                        ...
                                        <li className="footer-mobile-number"><i className="fa fa-phone" /><a href={`tel:${process.env.REACT_APP_MOBILE}`}>{process.env.REACT_APP_MOBILE}</a></li>
                                        <li className="footer-mobile-number"><i className="fa fa-envelope" /><a href={`mailto:${process.env.REACT_APP_EMAIL}`}>{process.env.REACT_APP_EMAIL}</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>

...
>
  <div className="container">
          ...
          <div className="form-inner">
            ...
            >
              ...
              <div className="row pb-0">
                ...
                <select name="pickup_hours" id="pickup_hours" class="select-time pl-2" placeholder="Select Pickup Time Range">
                  <option value="" selected >Select Pickup Time Range</option>
                ...
                <div className="col-md-12">
                  ...
                  <p>
                    ...
                    <small>
                      <em>
                        <i className="fa-solid fa-circle-info" /> Courier
                        service is available between 9:00 a.m. to 6:00 p.m. from
                        Monday to Saturday. The requests scheduled for
                        non-working hours will be honoured the very next day
            ...
            >
              ...
              <div className="row booking-my-self-form">
                ...
                <div className="col-12 col-md-6 mb-5  ">
                  <div className="col-12 p-0 custom_radio mt-2">
                    <fieldset className="checkbox-group">
                      <legend className="checkbox-group-legend">
                        Pickup Emirates
                      </legend>
              ...
              <div className="row mt-3">
                <div className="col-12">
                  ...
                  <p>
                    Only documents up to 500 grams will be accepted for
                    delivery. The delivery will be refused if the contents are
                    not documents.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              <div className="row">
                ...
                <div className="col-12 mt-4">
                  <div
                    className="form-group form-group-mt"
                    style={{ height: 150 }}
                  >
                    <div className="col-12">
                      <div className="row">
                ...
                <div className="bsinfo">
                  ...
                  <ul className="bssub_info">
                    <li>
                      ...
                      <span>
                        <i className="fa fa-clock-o" /> 02:52 PM
                      </span>
                    </li>
                  </ul>
                </div>
    ...
    >
      ...
      <button className="btn-info custom-btn theme-2 d-none courier_submit_btn">
        Submit
      </button>
    </div>

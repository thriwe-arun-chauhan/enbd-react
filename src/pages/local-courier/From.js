      ...
      <div className="form-inner">
        ...
        >
          <input
            type="hidden"
            name="csrf_form_name"
            defaultValue="7bfa0c48c0ff64cc0a8491470695dd64"
            autoComplete="off"
          />
          <div className="row">
              ...
              <div className="row">
                <div className="col-12">
                  <h4 className="d-flex justify-content-between align-items-center">
                    <span>From </span>
                    <small className="small-txt">Courier Pickup Address</small>
                  </h4>
          ...
          <div className="row mt-3">
            <div className="col-12">
              ...
              <p>
                Only documents up to 500 grams will be accepted for delivery.
                The delivery will be refused if the contents are not documents.
              </p>
            </div>
          </div>
        </form>{" "}

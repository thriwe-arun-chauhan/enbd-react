        ...
        <div className="bread-inner">
          <div className="bread-menu">
            <ul>
              ...
              <li>
                <a href="javascript:void(0);">Car Servicing</a>
              </li>
            </ul>
          </div>
...
<div
  className="common-section car-servicing sw sw-theme-dots sw-justified"
  id="smartwizard"
>
  <div className="container">
    <ul className="nav">
              ...
              <div className="row mt-3">
                <div className="col-12">
                  ...
                  <p>
                    ...
                    the customer prior to booking the service. If the car is not
                    accepted by the service station it will still be counted as
                    a service availed. All charges with respect to car servicing
                    will be directly charged to the customer, we will only
                    facilitate the pickup or delivery of the car to and from the
                    service station.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              <div className="row">
                <div className="col-12 custom_radio">
                  ...
                  <label
                    className="form-check-label text-nowrap pl-0 checkbox-wrapper"
                    htmlFor="drop-service"
                  >
                    <input
                      className="form-check-input selected_service_facility"
                      type="radio"
                      name="select_service_facility"
                      id="drop-service"
                      defaultValue="drop-service"
                      defaultChecked="checked"
                      autoComplete="off"
                    />
                    <span>Drop to Service Station </span>
                  </label>
                  <label
                    className="form-check-label text-nowrap checkbox-wrapper"
                  ...
                  >
                    <input
                      ...
                      name="select_service_facility"
                      id="pickup-service"
                      defaultValue="pickup-service"
                      autoComplete="off"
                    />
                    <span>Pickup from Service Station </span>
                  </label>
                </div>
              </div>
              <div className="row mt-4">
                ...
                <div className="col-12 col-md-6 form-inti service-car">
                  <div className="form-group">
                    <div className="icon">
                      <i className="fa fa-user" />
                    </div>
                ...
                <div className="col-12 col-md-12 form-inti service-car">
                  <div className="form-group">
                    <div className="icon">
                ...
                <div className="col-12 col-lg-6 form-inti service-car">
                ...
                <div className="col-12 col-md-6 form-inti h-100 mb-5">
                  <div className="custom_radio mt-2">
                    ...
                    <label
                      className="form-check-label text-nowrap checkbox-wrapper pickup_city_radio"
                      htmlFor="selected_pickup_emirates_0"
                    >
                      <input
                        className="form-check-input selected_pickup_emirates"
                        sr_no={1}
                        type="radio"
                        id="selected_pickup_emirates_0"
                    ...
                    <label
                      className="form-check-label text-nowrap checkbox-wrapper pickup_city_radio"
                      htmlFor="selected_pickup_emirates_1"
                    >
                      <input
                        className="form-check-input selected_pickup_emirates"
                        sr_no={2}
                        type="radio"
                        id="selected_pickup_emirates_1"
                        defaultValue="Dubai"
                        name="pickup_city"
                        autoComplete="off"
                      />
                    ...
                    <label
                      className="form-check-label text-nowrap checkbox-wrapper pickup_city_radio"
                      htmlFor="selected_pickup_emirates_2"
                    >
                      <input
                        className="form-check-input selected_pickup_emirates"
                        sr_no={3}
                        type="radio"
                        id="selected_pickup_emirates_2"
                ...
                <div className="col-12 col-md-6 form-inti service-car hide_zip_vik">
                  <div className="form-group">
                    <div className="icon">
                ...
                <div className="col-12 col-md-6 form-inti service-car">
                  <div className="form-group">
                    ...
                    <input
                      ...
                      name="drop_name"
                      id="drop_name"
                      placeholder="Name Of Assigned Service Engineer"
                      autoComplete="off"
                    />
                  </div>
                </div>
              ...
              <div className="row" id="text_msg_drop">
              ...
              <div className="row">
                <div className="col-12 form-inlabel">
                  <div className="form-group form-group-mt" style={{}}>
                    <textarea
                ...
                <div className="bsinfo">
                  ...
                  <ul className="bssub_info">
                    <li>
                      <span>
                        <i className="fa fa-user" />{" "}
                        <span id="bk_sm_pickup_name" />
                      </span>
                    </li>
                    <li>
                      <span>
                        <i className="fa fa-mobile" />{" "}
                        <span id="bk_sm_pickup_mobile" />
                      </span>
                    </li>
                  </ul>
                  <ul className="bssub_info">
                    <li>
                      <span>
                        <i className="fa fa-map-marker" />{" "}
                        <span id="bk_sm_pickup_address" />{" "}
                        <span id="bk_sm_pickup_landmark" />{" "}
                        <span id="bk_sm_pickup_state" />{" "}
                ...
                <div className="bsinfo">
                  ...
                  <ul className="bssub_info">
                    <li>
                      <span>
                        <i className="fa fa-user" />{" "}
                        <span id="bk_sm_drop_name" />
                      </span>
                    </li>
                    <li>
                      <span>
                        <i className="fa fa-mobile" />{" "}
                        <span id="bk_sm_drop_mobile" />
                      </span>
                    </li>
                  </ul>
                  <ul className="bssub_info">
                    <li>
                      <span>
                        <i className="fa fa-map-marker" />{" "}
                        <span id="bk_sm_drop_address" />{" "}
                        <span id="bk_sm_drop_landmark" />{" "}
                        <span id="bk_sm_drop_state" />{" "}
              ...
              <li className="bslisting clearfix">
                ...
                <div className="bsinfo">
                  ...
                  <ul className="bssub_info">
                    <li>
                      <span>
                        <i className="fa fa-calendar" /> 07 Oct 2022
                      </span>
                      <span>
                        <i className="fa fa-clock-o" /> 04:51 PM
                      </span>
                    </li>
                  </ul>
                </div>
    ...
    >
      ...
      <button className="btn-info custom-btn theme-2 d-none service_submit_btn">
        Submit
      </button>
    </div>

    ...
    <div className="row mb-0">
      <div className="col-lg-6 col-md-8 col-12 m-auto">
        <div className="common-form mt-4 pb-0">
          ...
          <p className="text-center mb-0">Don’t go back or refresh the page</p>
            ...
            <div className="row">
              ...
              <div className="col-md-12 mb-1">
                <p className="text-center">
                  <small>
                    <strong>Note : </strong>Kindly use the eligible EmiratesNBD
                    card which you have selected while placing the booking
                    request.
                  </small>
                </p>
              </div>
              ...
              <div className="col-md-12">
                <div className="form-group text-center h-100">
                  ...
                  <h6 style={{ fontSize: 11 }}>
                    ...
                    <b style={{ fontSize: 12 }}>
                      Once validation is successful you will receive an email
                      from the payment gateway stating that the payment
                      transaction has been VOIDED.
                    </b>{" "}
                    You will also receive an email with the booking details from
                    THRIWE.
                  </h6>
                </div>
              </div>

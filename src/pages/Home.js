  ...
  return (
    <>
      ...
      <div className="container-fluid p-0" style={{ position: "relative" }}>
        <img
          src="https://emiratesnbdbenefits.thriwe.com/public/web/img/topbg.jpg"
          className="img-fluid w-100"
        />
        <div className="topcured-ft">
          <img
            src="https://emiratesnbdbenefits.thriwe.com/public/web/img/services/top-curved.png"
            className="img-fluid w-100"
          />
        </div>
      </div>
        ...
        <div className="container" data-aos="fade-up">
          ...
          <div className="row">
            <ul>
              <li
                onClick={() => {
                  setBenefitAndCardModel(true);
                  setbenefitType(1);
                }}
              >
                <span className="animate__animated animate__bounceIn delay1 enabled">
                  <div className="icon">
                    <img src="https://emiratesnbdbenefits.thriwe.com/public/web/img/services/golf.png" />
                  </div>
                  <h4>
                    Golf <br />
                    Booking
              ...
              >
                <span className="animate__animated animate__bounceIn delay2 enabled">
                  <div className="icon">
                    <img
                      src="https://emiratesnbdbenefits.thriwe.com/public/web/img/services/transfer.png"
                      className="img-fluid"
                      width="80px"
                    />
                  </div>
              ...
              >
                <span className="animate__animated animate__bounceIn delay3 enabled">
                  <div className="icon">
                    <img src="https://emiratesnbdbenefits.thriwe.com/public/web/img/services/courier.png" />
                  </div>
                  <h4>
                    Local <br />
                    Courier
              ...
              >
                <span className="animate__animated animate__bounceIn delay4 enabled">
                  <div className="icon">
                    <img src="https://emiratesnbdbenefits.thriwe.com/public/web/img/services/car-service.png" />
                  </div>
                  <h4>
                    Car <br />
                    Servicing
              ...
              >
                <span className="animate__animated animate__bounceIn delay5 enabled">
                  <div className="icon">
                    <img src="https://emiratesnbdbenefits.thriwe.com/public/web/img/services/car-registration.png" />
                  </div>
                  <h4>
                    Car
                    <br /> Registration
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-11 col-xl-7 col-lg-8 m-auto text-center">
              ...
              <p className="mt-2">
                EmiratesNBD Benefit program curated specially for its
                cardholders
                <br /> assures exclusive savings on every booking. Save big with
                each <br />
                  ...
                  <div className="profile-list">
                    <p className="light-gray">
                      <i>
                        <small>
                          {" "}
                          Once you start Booking - your savings logs will show
                          here.
                        </small>
                      </i>
                    </p>
      ...
      <BenefitAndCardModal
        show={benefitAndCardModel}
        benefitType={benefitType}
        onClose={() => setBenefitAndCardModel(false)}
      />
    </>
  );
}
